...
with open('f4.csv') as csvfile:
    ...
    for index,row in enumerate(reader):
        ...
        ############# COMPANIES ###############
        company_query = "INSERT INTO public.company(id, name, description, phone, email, website, twitter, linkedin, location, key_features) "+ \
        "VALUES ( "+str(id_company)+",'" + name+ "', '"+description+"', '"+phone+"', '"+email+"', '"+website+"', '"+twitter+"', '"+linkedin+"', '"+location+"', '"+key_features+"');"
